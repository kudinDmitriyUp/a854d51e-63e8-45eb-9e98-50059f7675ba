...
export const metadata: Metadata = {
  title: "FilmCraft - Professional Movie Making Software",
  description: "Create stunning movies with FilmCraft's professional video editing tools. 4K editing, VFX, collaboration features. Start your free trial today.",
  keywords: "video editing, movie maker, film editing software, 4K video editor, professional editing tools, cinema editing",
  metadataBase: new URL("https://filmcraft.com"),
  alternates: {
    canonical: "https://filmcraft.com"
  },
  openGraph: {
    title: "FilmCraft - Professional Movie Making Software",
    description: "Create stunning movies with FilmCraft's professional video editing tools. 4K editing, VFX, collaboration features.",
    siteName: "FilmCraft",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763372673924-321xqbyz.jpg",
      alt: "FilmCraft professional video editing interface"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "FilmCraft - Professional Movie Making Software",
    description: "Create stunning movies with FilmCraft's professional video editing tools.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763372673924-321xqbyz.jpg"]
  },
  robots: {
    index: true,
    follow: true
